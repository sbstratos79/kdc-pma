...
describe('createProject', () => {
  it('inserts a record and returns it', async () => {
    const result = await createProject({
      id: 'proj-1', name: 'HQ Tower', status: 'Planning', priority: 'High',
    });
  ...
  it('stores optional fields when provided', async () => {
    const result = await createProject({
      id: 'proj-2', name: 'Bridge', status: 'In Progress', priority: 'Medium',
      description: 'A big bridge', startDate: '2025-01-01', dueDate: '2025-12-31',
    });
