<script>
	...
	import { ptsDataStore, architectData, projectData, taskData } from '$lib/stores/ptsDataStore';
...
<div class="flex h-screen w-screen items-start justify-center">
	<div class="flex w-[98%] flex-col items-start justify-center">
		<PendingTasksCarousel taskData={$taskData} />
		<div
